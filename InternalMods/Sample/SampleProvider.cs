...
namespace IMK.SettingsUI.InternalMods.Sample
{
    ...
    public sealed class SampleProvider : ISettingsProvider, INavPageModelProvider
    {
        ...
        private List<ICardModel> BuildRootModels()
        {
            ...
            list.Add(new NavigationCardModel{ Id="Sample:ModifiersTest", Title="Modifiers Test", Desc="反射写入演示", OnClick = ()=> Navigate("Sample:ModifiersTest") });
            list.Add(new NavigationCardModel{ Id="Sample:RichMarkdownDemo", Title="Markdown Demo", Desc="基础 Markdown 示例", OnClick = ()=> Navigate("Sample:RichMarkdownDemo") });
            return list;
        }
