...
namespace IMK.SettingsUI.InternalMods.ItemModKitPanel
{
    ...
    internal sealed class SlotsDataSet : ITableDataSet
    {
        ...
        private sealed class SlotsRowAdapter : IRowAdapter
        {
            ...
            public object Get(string columnId){ switch(columnId){ case "key": return _r.key; case "occupied": return _r.occupied; case "type": return _r.type; default: return null; } }
