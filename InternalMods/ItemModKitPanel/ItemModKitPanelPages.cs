...
namespace IMK.SettingsUI.InternalMods.ItemModKitPanel
{
    internal static class ItemModKitPanelPages
    {
        ...
        public static List<ICardModel> BuildVariablesOnlyPage() => BuildStandardTablePage("imk.varsonly", "Variables", "编辑变量", () => new VariablesOnlySchema(), () => new VariablesOnlyDataSet(), "vars");
        public static List<ICardModel> BuildConstantsPage() => BuildStandardTablePage("imk.consts", "Constants", "编辑常量", () => new ConstantsSchema(), () => new ConstantsOnlyDataSet(), "consts");
        public static List<ICardModel> BuildTagsPage() => BuildStandardTablePage("imk.tags", "Tags", "编辑标签", () => new TagsSchema(), () => new TagsOnlyDataSet(), "tags");
        public static List<ICardModel> BuildStatsPage() => BuildStandardTablePage("imk.stats", "Stats", "查看并编辑当前物品的 Stats", () => new StatsSchema(), () => new StatsDataSet(), "stats");
        public static List<ICardModel> BuildSlotsPage() => BuildStandardTablePage("imk.slots", "Slots", "查看并编辑当前物品的插槽", () => new SlotsSchema(), () => new SlotsDataSet(), "slots");
        public static List<ICardModel> BuildModifiersPage() => BuildStandardTablePage("imk.mods", "Modifiers", "查看并编辑当前物品的 Modifiers（ModifierDescription）", () => new ModifiersSchema(), () => new ModifiersDataSet(), "modifiers");
